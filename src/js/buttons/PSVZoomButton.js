 ...
 */
export class PSVZoomButton extends AbstractButton {
  ...
  constructor(navbar) {
    ...
    this.__setIcon('zoom-out', zoomMinus);
    ...
    this.__setIcon('zoom-in', zoomPlus);
  ...
  __zoomIn() {
    ...
    this.psv.zoomIn();
    this.prop.longPressTimeout = window.setTimeout(() => this.__startLongPressInterval(1), 200);
  }
  ...
  __startLongPressInterval(value) {
    if (this.prop.buttondown) {
      this.prop.longPressInterval = window.setInterval(() => {
