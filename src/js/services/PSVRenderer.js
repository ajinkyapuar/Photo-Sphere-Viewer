 ...
 */
export class PSVRenderer extends AbstractService {
  ...
  /**
   * @summary Main event loop, calls {@link __render} if `prop.needsUpdate` is true
   * @param {int} timestamp
