 ...
 */
export class PSVTextureLoader extends AbstractService {
  ...
  __loadEquirectangularTexture(panorama) {
    ...
    return this.__loadXMP(panorama)
      .then(panoData => new Promise((resolve, reject) => {
        ...
        const onerror = (e) => {
          this.psv.viewer.__displayError('Cannot load image'); // FIXME
          reject(e);
  ...
  __loadCubemapTexture(panorama) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const onerror = (i, e) => {
        this.psv.viewer.__displayError('Cannot load image');
        reject(e);
  ...
  preloadPanorama(panorama) {
    ...
    return this.__loadTexture(panorama);
  }
